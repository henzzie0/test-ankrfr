...
function Wallet({ screen, setScreen, selected, setSelected }) {
    ...
    <>
      ...
      <Flex flex="1" bg="#fff">
        <Flex h="100vh" className="scPage" overflowY="scroll" direction="column" padding={["6%", "2% 20%"]} color="#4d4d4d" align="flex-start">
          ...
          <Flex fontSize="14px" mb="24px" cursor="pointer" onClick={() => {
            history.push("/")
            setScreen(screen)
            setSelected(selected)
            }} align="center"><i className="mdi mdi-chevron-left" style={{ fontSize: "16px" }}></i> Back</Flex>
